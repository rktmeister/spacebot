...
- `smtp_invites_enabled = true` tells Spacebot to send invite and cancel emails itself using the configured SMTP credentials instead of relying solely on CalDAV server-side scheduling
