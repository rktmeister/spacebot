...
Spacebot also applies a small Telegram-specific cleanup pass before rendering so obviously collapsed inline lists such as `by:1. ...2. ...`, compact date/time text such as `March13,2026 at2:00 PM`, and collapsed heading/list seams such as `**Heading:**- item` are rewritten into more readable Telegram-safe text.
